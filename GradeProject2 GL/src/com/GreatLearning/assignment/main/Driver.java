...
import com.GreatLearning.assignment.service.AdditionalService;
	...
	public static void main(String[] args) {
		...
		do {
			...
			case 0:
				...
				break;
			case 1: {
				additionalService.displayPricesAscendingOrder(priceArray);

			}
				break;
			case 2: {
				additionalService.displayPricesDescendingOrder(priceArray);
